...
namespace Ks.Avalonia.Controls
{
    ...
    /// </summary>
    public class OrderedDockPanel : Panel
    {
        /// <summary>
        /// Defines the Dock attached property.
        /// </summary>
        public static readonly AttachedProperty<Dock> DockProperty = DockPanel.DockProperty.AddOwner<OrderedDockPanel>();

        /// <summary>
        /// Defines the Order attached property.
        /// </summary>
        public static readonly AttachedProperty<int> OrderProperty =
            AvaloniaProperty.RegisterAttached<OrderedDockPanel, Control, int>("Order");

        /// <summary>
        /// Defines the <see cref="LastChildFill"/> property.
        /// </summary>
        public static readonly StyledProperty<bool> LastChildFillProperty = DockPanel.LastChildFillProperty.AddOwner<OrderedDockPanel>();

        /// <summary>
        /// Initializes static members of the <see cref="OrderedDockPanel"/> class.
        /// </summary>
        static OrderedDockPanel()
        {
            AffectsParentMeasure<OrderedDockPanel>(DockProperty);
            AffectsParentMeasure<OrderedDockPanel>(OrderProperty);
        }
        ...
        /// <summary>
        /// Gets the value of the Order attached property on the specified control.
        /// </summary>
        /// <param name="control">The control.</param>
        /// <returns>The Order attached property.</returns>
        public static int GetOrder(Control control)
        {
            return control.GetValue(OrderProperty);
        }

        /// <summary>
        /// Sets the value of the Order attached property on the specified control.
        /// </summary>
        /// <param name="control">The control.</param>
        /// <param name="value">The value of the Order property.</param>
        public static void SetOrder(Control control, int value)
        {
            control.SetValue(OrderProperty, value);
        }

        /// <summary>
        /// Gets or sets a value which indicates whether the last child of the
        /// <see cref="OrderedDockPanel"/> fills the remaining space in the panel.
        /// </summary>
        public bool LastChildFill
        {
            get => this.GetValue(LastChildFillProperty);
            set => this.SetValue(LastChildFillProperty, value);
        }

        /// <summary>
        /// Updates DesiredSize of the OrderedDockPanel.  Called by parent Control.  This is the first pass of layout.
        /// </summary>
        /// <remarks>
        ...
        protected override Size MeasureOverride(Size constraint)
        {
            ...
            foreach (var child in children.OrderBy(ch => ch == null ? 0 : GetOrder((Control) ch)))
            {
        ...
        /// <summary>
        /// OrderedDockPanel computes a position and final size for each of its children based upon their
        /// <see cref="Dock" /> enum and sizing properties.
        /// </summary>
        /// <param name="arrangeSize">Size that OrderedDockPanel will assume to position children.</param>
        protected override Size ArrangeOverride(Size arrangeSize)
        {
            ...
            foreach (var child in children.OrderBy(ch => ch == null ? 0 : GetOrder((Control) ch)))
            {
                ...
                {
                    switch (OrderedDockPanel.GetDock((Control)child))
                    {
                        case Dock.Left:
