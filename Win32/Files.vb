...
Namespace Common.Win32
    ...
    Public MustInherit Class Files
        ...
        Public MustInherit Class Unsafe
            ...
            Public Shared Function CreateHardLinkW(ByVal lpFileName As String, ByVal lpExistingFileName As String, ByVal lpSecurityAttributes As IntPtr) As Boolean
            End Function

        End Class

        Public Shared Sub CreateHardLink(ByVal FileName As String, ByVal ExistingFileName As String)
            Dim R = Unsafe.CreateHardLinkW(FileName, ExistingFileName, IntPtr.Zero)
            If Not R Then
                Common.ThrowError()
            End If
        End Sub
