...
Namespace Common.Win32
    ...
    Partial Class Hooks
        ...
        Public MustInherit Class Unsafe
            ...
            Public Shared Function SetWindowsHookEx(idHook As HookType, lpfn As KeyboardProc, hMod As IntPtr, dwThreadId As UInteger) As IntPtr
            End Function
            ...
            ''' </returns>
            <DllImport("User32.dll", SetLastError:=True)>
            Public Shared Function SetWindowsHookEx(idHook As HookType, lpfn As LowLevelKeyboardProc, hMod As IntPtr, dwThreadId As UInteger) As IntPtr
            End Function
            ...
            ''' </returns>
            <DllImport("User32.dll", SetLastError:=True)>
            Public Shared Function SetWindowsHookEx(idHook As HookType, lpfn As MouseProc, hMod As IntPtr, dwThreadId As UInteger) As IntPtr
            End Function
            ...
            ''' </returns>
            <DllImport("User32.dll", SetLastError:=True)>
            Public Shared Function SetWindowsHookEx(idHook As HookType, lpfn As LowLevelMouseProc, hMod As IntPtr, dwThreadId As UInteger) As IntPtr
            End Function
            ...
            ''' </remarks>
            <DllImport("User32.dll", SetLastError:=True)>
            Public Shared Function CallNextHookEx(hhk As IntPtr, nCode As Integer, wParam As UIntPtr, lParam As IntPtr) As Boolean
            End Function
