...
namespace Ks.Common
{
    public abstract class BinaryFormatterBase : Formatter
    {
        public BinaryFormatterBase()
        {
            ...
            {
                F.Get(null, new SerializationArrayChunk<byte>(TempArray, 0, 1));
            ...
            {
                F.Get(null, new SerializationArrayChunk<byte>(TempArray, 0, 2));
            ...
            {
                F.Get(null, new SerializationArrayChunk<byte>(TempArray, 0, 4));
            ...
            {
                F.Get(null, new SerializationArrayChunk<byte>(TempArray, 0, 8));
